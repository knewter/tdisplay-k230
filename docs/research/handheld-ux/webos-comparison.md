...
| --- | --- | --- | --- |
| Persistent entry | webOS OSE describes an app bar for quick access to favorite or running apps. | The K230 has a fixed 56px **top** bar for Apps, Windows, Keyboard, and System. | Keep this top bar: the narrow portrait panel and existing source use it. Do not copy a bottom app bar or make entry gesture-only. UX-02 asks that Home recovery be disclosed more clearly. |
