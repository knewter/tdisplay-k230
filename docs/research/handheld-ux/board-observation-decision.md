...
| UX-06 | Cold unattended boot to usable shell. | selected boot/onboarding owner | `flock /tmp/k230-board.lock python3 tools/capture-boot.py --dev /dev/ttyACM0 --out /tmp/k230-ux-boot.txt --seconds 120` | Battery-only/cold startup timing. |
