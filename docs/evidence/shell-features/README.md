...
| --- | --- | --- | --- | --- |
| Portrait app launcher | — | [menu.png](portrait-launcher/menu.png), [monitor.png](portrait-launcher/monitor.png), [keyboard.png](portrait-launcher/keyboard.png), [drag-cancelled.png](portrait-launcher/drag-cancelled.png) | [20260922T185608Z-portrait-launcher.mp4](portrait-launcher/20260922T185608Z-portrait-launcher.mp4) | Injected touchscreen events on the physical board; Terminal/Monitor/New Terminal/Back, keyboard path, repeated Apps, and cancelled drag are in [console.txt](portrait-launcher/console.txt); no finger-accuracy claim |
