...
OUT=pathlib.Path('/run/gpu-padded-'+('pixman' if FORCE else 'gpu'));OUT.mkdir(exist_ok=True)
PYTHON='/nix/store/v189xydz6qkcd4cbkixcmv91w8hbc560-python3-riscv64-unknown-linux-gnu-3.14.7/bin/python3'
SWAY='/nix/store/26mglvlajp14a7yc3ami5kwavzsks1bi-sway-unwrapped-riscv64-unknown-linux-gnu-1.12/bin/sway'
