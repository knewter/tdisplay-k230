...
for (const href of ["javascript:alert(1)", "data:text/html,evil", "//private.example/", "http://example.com/", "https://127.0.0.1/private", "https://example.com/unreviewed", "/tmp/hidden"])
...
console.log("work Markdown links: 15 assertions passed");
