...
- Keep one primary card link with a stretched hit area; separate header evidence links remain independent anchors. Avoid nested anchors, autoplaying card previews and a separate View details button.
...
- Large galleries → lazy image loading and video metadata loading, no card-preview autoplay or large media duplication in the site bundle.
