...
- [x] 3.2 Once all named proof exists, archive/sync the docs/spec-site delta and publish the reconciled result. No physical-board claim is part of this change.
